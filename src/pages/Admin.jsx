...
export default function Admin() {
  ...
  const handleThumbnailsUpload = async (e) => {
    ...
    setForm((prev) => ({
      ...prev,
      thumbnails: [...(prev.thumbnails || []), ...valid],
    }));
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] px-4 md:px-10 py-10">
      ...
      <div className="flex flex-col gap-5 mb-10 md:flex-row md:items-center md:justify-between">
        <div>
          <p className="text-white/20 text-[10px] tracking-[0.4em] uppercase mb-1">
            Dashboard
          </p>
        ...
        <div className="flex gap-3">
          {!showForm && (
            <motion.button
              ...
              className="flex-1 md:flex-none flex items-center justify-center gap-2 bg-white text-black px-5 py-2.5 text-xs font-semibold tracking-widest uppercase hover:bg-white/90 transition-colors"
            >
          ...
          <motion.button
            ...
            className="flex-1 md:flex-none flex items-center justify-center gap-2 border border-white/10 text-white/40 hover:text-white px-4 py-2.5 text-xs tracking-widest uppercase transition-colors"
          >
